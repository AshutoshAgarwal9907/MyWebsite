...
<Router> 
    <div className=" bg-black  text-white p-5 flex space-x-96">
        ...
        <Link to="/Explore" className="m-5 text-yellow-400 ">Explore</Link> 
        <Link to="/Product" className="m-5">Product</Link> 
        <Link to="/Developer" className="m-5">Developer</Link>
        <Link to="/Signin" className="m-5">Sign in</Link>
